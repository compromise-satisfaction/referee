  ...
  core.onload = function(){
    ...
    function Scene_loads(Number,Datas,Return,Flag,Item){
      ...
      switch (Number) {
        ...
        case 3:
          var Text = "「おはようございます」";
          Datas = [1,0,S_image,15,0,0,0,0,Surname+" "+Name,Text,Number-1,1,Number,31,Number+1,0,0];
          core.replaceScene(MainScene(Datas,Return,Flag));
          break;
        case 4:
          var Text = "事務所の扉を開け、中にいる人物に挨拶する。";
          Datas = [1,0,S_image,0,0,0,0,0,"",Text,Number-1,1,Number,31,Number+1,0,0];
          core.replaceScene(MainScene(Datas,Return,Flag));
          break;
        case 5:
          var T_Name = "聖ヶ丘 剣哉";
          var Text = "「ああ、おはよう"+Surname+"くん」";
          Datas = [1,0,S_image,0,0,0,1,15,T_Name,Text,Number-1,1,Number,31,Number+1,0,0];
          core.replaceScene(MainScene(Datas,Return,Flag));
          break;
        case 6:
          var Text = "机に座り書類を処理しながら反応するのは男性にしては長めの髪型をした壮年の男性ー"+Person+"がお世話になっているこの法律事務所の所長、聖ヶ丘 剣哉 だ";
          Datas = [1,0,S_image,0,0,0,1,0,"",Text,Number-1,1,Number,31,Number+1,0,0];
          core.replaceScene(MainScene(Datas,Return,Flag));
          break;
        case 7:
          var Text = "「所長、"+Person+"に用件があるとお聞きしたのですが一体何の御用でしょう？」";
          Datas = [1,0,S_image,0,0,0,1,0,Name,Text,Number-1,1,Number,31,Number+1,0,0];
          core.replaceScene(MainScene(Datas,Return,Flag));
          break;
        case 8:
        ...
        case 9:
          ...
          Datas = [1,0,S_image,0,0,0,1,0,T_Name,Text,Number-1,1,Number,31,Number+1,0,0];
          core.replaceScene(MainScene(Datas,Return,Flag));
          break;
        case 10:
